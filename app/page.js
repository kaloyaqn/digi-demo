...
export default function Home() {
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="ai-driven bg-[#161917] rounded-t-[64px] md:pt-40 md:pb-36">
        <div className="container mx-auto">
          <img
            src="./images/ai-icon.svg"
            alt="AI-driven process"
            className="mb-10"
          />
          <h2 className="text-5xl md:max-w-6xl md:leading-[85px] mb-16">
            Our
